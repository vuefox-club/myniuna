...
if(isset($_POST['signup']))
{
	...
	$a=date('Y-m-d');
	$msg=mysqli_query($con,"insert into users(fname,tname,lname,email,password,contactno,posting_date) values('$fname','$tname','$lname','$email','$enc_password','$contact','$a')");
if($msg)
{
					...
					<div class="facts">
						...
						<div class="register">
							<form name="registration" method="post" action="" enctype="multipart/form-data">
								...
								<p>Select the Department whose events you want to enrol in(Select Any One) </p>
								<input type="radio" class="text" value="CSE"  name="tname" required >CSE<br>
								<input type="radio" class="text" value="ECE"  name="tname" required >ECE<br>
								<input type="radio" class="text" value="EEE"  name="tname" required >EEE<br>
								<input type="radio" class="text" value="MECH"  name="tname" required >MECH<br>
								<input type="radio" class="text" value="CIVIl"  name="tname" required >CIVIL<br>
