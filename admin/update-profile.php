...
if(isset($_POST['Submit']))
{
	...
	mysqli_query($con,"update users set fname='$fname' , tname='$tname' , lname='$lname' , contactno='$contact' where id='".$_GET['uid']."'");
				...
				<div class="row">
                  ...
                  <div class="col-md-12">
                      ...
                      <p align="center" style="color:#F00;"><?php echo $_SESSION['msg']=""; ?></p>
						  ...
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">hello</label>
                              <div class="col-sm-10">
